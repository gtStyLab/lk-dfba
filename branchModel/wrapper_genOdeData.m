function datasetFileName = wrapper_genOdeData(paramSetNum,dataDir)
...
% combination of CoV and lo-res nT values. 
    ...
    datasetFileName = sprintf('branch_k-%02d_hiRes.mat',paramSetNum);
    ...
    % Params = [bm3; bm4;  a2; b21;   a3;  b32; br34;   a4;  b41; br43;   a5;   b53;  b54];
    try
        paramsVec = getParamsVecNum(paramSetNum);
...
% %         [odeDataset.timeVec, odeDataset.concMatrix, odeDataset.fluxMatrix] = solveODE(odeDataset.tStart,odeDataset.tEnd,odeDataset.nT,odeDataset.x0,odeDataset.paramsVec);
        [odeDataset.timeVec, odeDataset.concMatrix, odeDataset.fluxMatrix] = solveOdeBstBranch(odeDataset.tStart,odeDataset.tEnd,odeDataset.nT,odeDataset.x0,odeDataset.paramsVec);
