...
resultsDir = 'results_unsplit';

loadFileNameList_chassNoisy

genMatlab = 1;
    matlabCommandFileName = 'driver_runAllChassFits_matlab_unsplit.m';
genPBS = 0;
    commandListFileName = 'driver_runAllChassFits_PBS_unsplit.sh';
...
for i = 1:length(fileNameList)
    ...
    if ~exist(rFile,'file')
        ...
        jobStruct(k).commandString = sprintf('wrapper_fitChassNoisyUnsplit(''%s'',{''LR''})',fileNameList{i});
        k=k+1;
    end
end
